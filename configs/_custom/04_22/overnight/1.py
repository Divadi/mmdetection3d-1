work_dir = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_22/overnight/1"
...
db_sampler = dict(
    data_root=gen_root,
    info_path=gen_root + 'aiodrive_denselv1_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=gen_root + 'aiodrive_velodyne_infos_train.pkl', # same for all point densities
            split='trainval',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=gen_root + 'aiodrive_velodyne_infos_val.pkl', # same for all point densities
        split='trainval',
        pts_prefix='lidar_denselv1',
