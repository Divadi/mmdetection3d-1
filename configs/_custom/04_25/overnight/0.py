work_dir = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_25/overnight/0"
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_dir=dict(
            type='CrossEntropyLoss', use_sigmoid=True, loss_weight=0.2)), # TODO: True for single class
...
class_names = ['Car'] # appears like order is important.
