work_dir = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_21/overnight/1"
...
model = dict(
    ...
    pts_voxel_layer=dict(
        ...
        max_voxels=(64000, 160000)), # 80k was chosen just by multiplying 2.5 to training num voxels.
    ...
    pts_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=64, output_shape=[800, 1024]),
    pts_backbone=dict(
        type='SECOND',
        in_channels=64,
