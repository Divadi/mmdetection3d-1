work_dir = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_18/day/1"
...
model = dict(
    ...
    pts_voxel_layer=dict(
        ...
        max_voxels=(32000, 80000)), # 80k was chosen just by multiplying 2.5 to training num voxels.
    ...
    pts_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=64, output_shape=[400, 512]),
    pts_backbone=dict(
        type='SECOND',
        in_channels=64,
...
data = dict(
    ...
    train=dict(
        type='RepeatDataset',
        times=1, # TODO: Changed this to 1 for fine-tuning on entire.
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
...
lr = 0.0001 / 2 * 3
optimizer = dict(type='AdamW', lr=lr, weight_decay=0.01) # 10x lower starting lr for fine tuning.
...
log_level = 'INFO'
load_from = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_18/day/0/epoch_30.pth"
resume_from = None
workflow = [('train', 1)]
