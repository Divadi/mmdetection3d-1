work_dir = "/home/david/src/S21/aiodrive/mmdetection3d-1/outputs/04_18/day/0"
...
point_cloud_range = [0, -39.68, -4, 69.12, 39.68, 2] # likely change z-axis range for SECOND-based.
model = dict(
    type='MVXFasterRCNN',
    pts_voxel_layer=dict(
        ...
        max_voxels=(16000, 40000)), # 80k was chosen just by multiplying 2.5 to training num voxels.
    ...
    pts_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=64, output_shape=[248, 216]),
    pts_backbone=dict(
        type='SECOND',
        in_channels=64,
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
                [0, -39.68, -3.448, 69.12, 39.68, -3.448], # Car 
                [0, -39.68, -2.957, 69.12, 39.68, -2.957], # Pedestrian
                [0, -39.68, -3.726, 69.12, 39.68, -3.726], # Cyclist
                [0, -39.68, -3.387, 69.12, 39.68, -3.387]  # Motorcycle
            ],
            sizes=[
                [2.13, 4.70, 1.70], # Car
