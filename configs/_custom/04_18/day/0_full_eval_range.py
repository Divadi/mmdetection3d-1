...
point_cloud_range = [-81.92, -81.92, -4, 81.92, 81.92, 2] # likely change z-axis range for SECOND-based.
model = dict(
    type='MVXFasterRCNN',
    ...
    pts_bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[
                [-81.92, -81.92, -3.448, 81.92, 81.92, -3.448], # Car 
                [-81.92, -81.92, -2.957, 81.92, 81.92, -2.957], # Pedestrian
                [-81.92, -81.92, -3.726, 81.92, 81.92, -3.726], # Cyclist
                [-81.92, -81.92, -3.387, 81.92, 81.92, -3.387]  # Motorcycle
            ],
            sizes=[
                [2.13, 4.70, 1.70], # Car
...
val_load_interval = 1 # ends up with 3k
